		...
		$(function() {
			...
			// Disable animations/transitions until the page has loaded.
				...
				$window.on('load', function() {
					...
					$("#salary").autoNumeric('init', options);
					$("#bonus").autoNumeric('init', options);
			...
			$( "#salarySurvey" ).submit(function( event ) {
				event.preventDefault();
				$("#salary").autoNumeric('unSet');
				$("#bonus").autoNumeric('unSet');
				
				console.log("Salary: " + $("#salary").val());

				$.post('/user/survey', { salary: $('#salary').val(), bonus: $('#bonus').val() })
			      .done(function(data){
